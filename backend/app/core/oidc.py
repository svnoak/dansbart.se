...
def validate_token(token: str) -> Dict:
    ...
    This function:
    1. Fetches public keys from Authentik's JWKS endpoint
    2. Verifies token signature using the appropriate public key
    3. Validates issuer, audience, and expiration
    4. Returns decoded token payload with user claims
