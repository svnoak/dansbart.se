...
Usage:
    from app.services.style_keywords_cache import get_keywords, invalidate_cache

    # In StyleClassifier
    keywords = get_keywords(db)  # Returns dict: keyword -> (main_style, sub_style)
...
def get_sorted_keywords(db: Session) -> List[Tuple[str, str, Optional[str]]]:
    ...
    # Cache is already sorted by length, convert to list of tuples
