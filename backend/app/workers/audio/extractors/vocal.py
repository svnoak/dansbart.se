def analyze_vocal_presence(audio_array, sample_rate=16000):
    """
    ...
    # Note: Ensure you have the .pb model file in your path
    # 'voice_instrumental-discriminator-muscnn-flow.pb' is the standard Essentia one
    MODEL_FILENAME = "voice_instrumental-musicnn-msd-1.pb" 
    model_path = f"/app/app/workers/audio/models/{MODEL_FILENAME}"

    if not os.path.exists(model_path):
        print(f"      ⚠️ VOCAL MODEL MISSING at: {model_path}")
