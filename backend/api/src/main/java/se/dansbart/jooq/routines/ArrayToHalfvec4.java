...
public class ArrayToHalfvec4 extends AbstractRoutine<Object> {
     ...
     */
    public ArrayToHalfvec4() {
        super("array_to_halfvec", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"public\".\"halfvec\""));
