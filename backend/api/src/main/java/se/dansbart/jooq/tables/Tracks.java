...
public class Tracks extends TableImpl<Record> {
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_TRACKS_PROCESSING_STATUS, Indexes.IX_TRACKS_ANALYSIS_VERSION, Indexes.IX_TRACKS_IS_DANCEABLE, Indexes.IX_TRACKS_IS_FLAGGED, Indexes.IX_TRACKS_ISRC, Indexes.IX_TRACKS_MUSIC_GENRE, Indexes.IX_TRACKS_PROCESSING_STATUS, Indexes.IX_TRACKS_TITLE, Indexes.IX_TRACKS_UPLOADER_ID);
    }
