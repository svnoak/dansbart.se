...
public class HalfvecRecv extends AbstractRoutine<Object> {
     ...
     */
    public HalfvecRecv() {
        super("halfvec_recv", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"public\".\"halfvec\""));
