...
public class Ivfflathandler extends AbstractRoutine<Object> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", DefaultDataType.getDefaultDataType("\"pg_catalog\".\"index_am_handler\""), false, false);
    ...
    public Ivfflathandler() {
        super("ivfflathandler", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"index_am_handler\""));
