...
public class HalfvecAccum extends AbstractRoutine<Double[]> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>public.halfvec_accum.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.halfvec_accum._1</code>.
     */
     ...
     */
    public HalfvecAccum() {
        super("halfvec_accum", Public.PUBLIC, SQLDataType.FLOAT.array());
