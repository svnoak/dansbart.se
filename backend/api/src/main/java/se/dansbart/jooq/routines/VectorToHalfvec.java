...
public class VectorToHalfvec extends AbstractRoutine<Object> {
     ...
     */
    public VectorToHalfvec() {
        super("vector_to_halfvec", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"public\".\"halfvec\""));
