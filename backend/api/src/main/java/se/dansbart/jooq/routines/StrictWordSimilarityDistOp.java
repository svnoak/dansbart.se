...
public class StrictWordSimilarityDistOp extends AbstractRoutine<Float> {
     ...
     */
    public StrictWordSimilarityDistOp() {
        super("strict_word_similarity_dist_op", Public.PUBLIC, SQLDataType.REAL);
