...
public class GtrgmPicksplit extends AbstractRoutine<Object> {
     ...
     */
    public GtrgmPicksplit() {
        super("gtrgm_picksplit", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
