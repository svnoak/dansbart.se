...
public class SparsevecToVector extends AbstractRoutine<Object> {
     ...
     */
    public SparsevecToVector() {
        super("sparsevec_to_vector", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"public\".\"vector\""));
