...
public class HnswSparsevecSupport extends AbstractRoutine<Object> {
     ...
     */
    public HnswSparsevecSupport() {
        super("hnsw_sparsevec_support", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
