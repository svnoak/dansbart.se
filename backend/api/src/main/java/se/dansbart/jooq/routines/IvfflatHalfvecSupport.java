...
public class IvfflatHalfvecSupport extends AbstractRoutine<Object> {
     ...
     */
    public IvfflatHalfvecSupport() {
        super("ivfflat_halfvec_support", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
