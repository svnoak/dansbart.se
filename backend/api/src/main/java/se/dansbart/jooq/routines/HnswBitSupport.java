...
public class HnswBitSupport extends AbstractRoutine<Object> {
     ...
     */
    public HnswBitSupport() {
        super("hnsw_bit_support", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
