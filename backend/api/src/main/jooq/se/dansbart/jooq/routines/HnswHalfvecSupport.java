...
public class HnswHalfvecSupport extends AbstractRoutine<Object> {
     ...
     */
    public HnswHalfvecSupport() {
        super("hnsw_halfvec_support", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
