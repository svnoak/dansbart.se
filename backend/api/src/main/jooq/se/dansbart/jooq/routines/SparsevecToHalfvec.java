...
public class SparsevecToHalfvec extends AbstractRoutine<Object> {
    ...
    /**
     * The parameter <code>public.sparsevec_to_halfvec._2</code>.
     */
    public static final Parameter<Integer> _2 = Internal.createParameter("_2", SQLDataType.INTEGER, false, true);

    /**
     * The parameter <code>public.sparsevec_to_halfvec._3</code>.
     */
     ...
     */
    public SparsevecToHalfvec() {
        super("sparsevec_to_halfvec", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"public\".\"halfvec\""));
