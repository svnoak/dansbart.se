...
public class SparsevecRecv extends AbstractRoutine<Object> {
     ...
     */
    public SparsevecRecv() {
        super("sparsevec_recv", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"public\".\"sparsevec\""));
