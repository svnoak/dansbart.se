...
public class HalfvecToSparsevec extends AbstractRoutine<Object> {
     ...
     */
    public HalfvecToSparsevec() {
        super("halfvec_to_sparsevec", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"public\".\"sparsevec\""));
