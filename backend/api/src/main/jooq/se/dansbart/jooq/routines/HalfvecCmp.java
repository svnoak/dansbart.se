...
public class HalfvecCmp extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>public.halfvec_cmp.RETURN_VALUE</code>.
     */
     ...
     */
    public HalfvecCmp() {
        super("halfvec_cmp", Public.PUBLIC, SQLDataType.INTEGER);
