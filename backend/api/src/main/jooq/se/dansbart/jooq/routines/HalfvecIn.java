...
public class HalfvecIn extends AbstractRoutine<Object> {
     ...
     */
    public HalfvecIn() {
        super("halfvec_in", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"public\".\"halfvec\""));
