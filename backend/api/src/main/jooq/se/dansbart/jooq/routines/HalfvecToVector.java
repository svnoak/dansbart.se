...
public class HalfvecToVector extends AbstractRoutine<Object> {
     ...
     */
    public HalfvecToVector() {
        super("halfvec_to_vector", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"public\".\"vector\""));
