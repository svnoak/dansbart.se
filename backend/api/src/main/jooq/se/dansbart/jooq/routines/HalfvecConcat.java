...
public class HalfvecConcat extends AbstractRoutine<Object> {
     ...
     */
    public HalfvecConcat() {
        super("halfvec_concat", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"public\".\"halfvec\""));
