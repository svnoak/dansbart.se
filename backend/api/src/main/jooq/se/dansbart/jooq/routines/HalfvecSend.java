...
public class HalfvecSend extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>public.halfvec_send.RETURN_VALUE</code>.
     */
     ...
     */
    public HalfvecSend() {
        super("halfvec_send", Public.PUBLIC, SQLDataType.BLOB);
