...
public class Indexes {
    ...
    public static final Index IX_PLAYLIST_COLLABORATORS_PLAYLIST_ID = Internal.createIndex(DSL.name("ix_playlist_collaborators_playlist_id"), PlaylistCollaborators.PLAYLIST_COLLABORATORS, new OrderField[] { PlaylistCollaborators.PLAYLIST_COLLABORATORS.PLAYLIST_ID }, false);
    public static final Index IX_PLAYLIST_COLLABORATORS_STATUS = Internal.createIndex(DSL.name("ix_playlist_collaborators_status"), PlaylistCollaborators.PLAYLIST_COLLABORATORS, new OrderField[] { PlaylistCollaborators.PLAYLIST_COLLABORATORS.STATUS }, false);
    public static final Index IX_PLAYLIST_COLLABORATORS_USER_ID = Internal.createIndex(DSL.name("ix_playlist_collaborators_user_id"), PlaylistCollaborators.PLAYLIST_COLLABORATORS, new OrderField[] { PlaylistCollaborators.PLAYLIST_COLLABORATORS.USER_ID }, false);
    ...
    public static final Index IX_TRACKS_ISRC = Internal.createIndex(DSL.name("ix_tracks_isrc"), Tracks.TRACKS, new OrderField[] { Tracks.TRACKS.ISRC }, true);
    ...
    public static final Index IX_TRACKS_PROCESSING_STATUS = Internal.createIndex(DSL.name("ix_tracks_processing_status"), Tracks.TRACKS, new OrderField[] { Tracks.TRACKS.PROCESSING_STATUS }, false);
    ...
    public static final Index IX_USERS_USERNAME = Internal.createIndex(DSL.name("ix_users_username"), Users.USERS, new OrderField[] { Users.USERS.USERNAME }, false);
