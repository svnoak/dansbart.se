...
public class IvfflatBitSupport extends AbstractRoutine<Object> {
     ...
     */
    public IvfflatBitSupport() {
        super("ivfflat_bit_support", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
