...
public class VectorToSparsevec extends AbstractRoutine<Object> {
     ...
     */
    public VectorToSparsevec() {
        super("vector_to_sparsevec", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"public\".\"sparsevec\""));
