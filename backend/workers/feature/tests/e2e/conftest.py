...
def test_db_url():
    ...
    return os.environ.get(
        "TEST_DATABASE_URL", "postgresql://postgres:password@localhost:5432/dansbart_test"
    )
...
def mock_spotify_client(
    ...
    with patch("spotipy.Spotify") as MockSpotify:
        ...
        # Batch tracks
        client.tracks.return_value = {"tracks": [mock_spotify_track_response]}
        ...
        client.artist_albums.return_value = {"items": [mock_spotify_album_response], "next": None}
...
def sample_analysis_result():
    ...
    return {
        ...
        "raw_artifacts": {
            ...
            "musicnn": {"avg_embedding": [0.0] * 200, "frame_embeddings": []},
...
def e2e_env_vars(monkeypatch):
    ...
    monkeypatch.setenv(
        "DATABASE_URL", "postgresql://postgres:password@localhost:5432/dansbart_test"
    )
