      ...
      <div v-else-if="album">
        ...
        <div class="mb-8">
          <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="mb-3">
              <span
                v-for="(artist, index) in album.allArtists"
                :key="artist.id"
                class="text-lg"
              >
                <a
                ...
                <span v-if="index < album.allArtists.length - 1" class="text-gray-500">, </span>
              </span>
            </div>

            <div class="flex items-center gap-4 text-gray-600">
              <!-- Release Date -->
              <p v-if="album.releaseDate" class="flex items-center gap-2">
