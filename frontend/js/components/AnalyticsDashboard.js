                ...
                <div class="bg-gray-800/50 rounded-lg p-6">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-white">{{ analytics.listen_time.total_hours }}</p>
                        </div>
                        <div>
                            <p class="text-gray-400 text-sm">Total Minutes</p>
                            <p class="text-2xl font-bold text-white">{{ analytics.listen_time.total_minutes }}</p>
                        </div>
                        <div>
                            <p class="text-gray-400 text-sm">Formatted</p>
                            <p class="text-lg font-mono text-purple-400">{{ analytics.listen_time.formatted }}</p>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                            <tr v-for="(track, index) in analytics.most_played_tracks" :key="track.track_id"
                                ...
                                <td class="py-3 pr-4 text-white font-medium">{{ track.track_title }}</td>
                                <td class="py-3 pr-4 text-gray-400">{{ track.artist || 'Unknown' }}</td>
                                <td class="py-3 pr-4 text-right text-white">{{ track.total_plays }}</td>
                                <td class="py-3 pr-4 text-right text-green-400">{{ track.completed_plays }}</td>
