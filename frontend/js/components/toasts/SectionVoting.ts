...
/** Minimal type for the structure version prop used in the watch. */
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      step: 'hidden',
      isSubmitting: false,
      showDelayTimer: null as ReturnType<typeof setTimeout> | null,
      autoDismissTimer: null as ReturnType<typeof setTimeout> | null,
    };
  },
  ...
  watch: {
    ...
    activeVersion: {
      ...
      handler(newVal: ActiveVersionLike | null) {
  ...
  methods: {
    ...
    async castVote(voteType: 'yes' | 'no') {
