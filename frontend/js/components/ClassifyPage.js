...
import { getVoterId } from '../utils/voter.js'; 
import { showToast, showError } from '../hooks/useToast.js';
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const fetchTracks = async () => {
        ...
        try {
            const params = new URLSearchParams({ sort: 'confidence', order: 'asc', limit: 20, offset: offset.value });
      ...
      try {
          ...
          fetch(`/api/tracks/${activeTrack.value.id}/feedback`, {
              ...
              body: JSON.stringify({
                ...
                main_style: selectedStyle.value,
