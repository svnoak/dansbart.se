        ...
        <div v-if="sourceTrack" class="p-4 bg-blue-50 border-b space-y-3">
          <div>
            ...
            <div class="flex gap-2 mt-2">
              <span class="text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded">{{ sourceTrack.danceStyle }}</span>
              <span v-if="sourceTrack.subStyle" class="text-xs bg-purple-100 text-purple-700 px-2 py-1 rounded">{{ sourceTrack.subStyle }}</span>
          ...
          <div>
            ...
            <div class="flex gap-2">
              <button
                ...
                :title="'Endast ' + sourceTrack.danceStyle"
              >
                Samma stil
              </button>
              <button
