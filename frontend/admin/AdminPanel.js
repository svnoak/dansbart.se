    ...
    template: `
        <div id="admin-panel" class="max-w-6xl mx-auto">
            ...
            <transition name="fade" mode="out-in">
                <keep-alive>
                    <component :is="activeTab === 'pending' ? 'reject-tab' : activeTab + '-tab'" />
                </keep-alive>
            </transition>
