                ...
                <div class="bg-gray-800/50 rounded-lg p-4 sm:p-6">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <p class="text-xl sm:text-2xl font-bold text-white">{{ analytics.listenTime?.totalHours }}</p>
                        </div>
                        <div>
                            <p class="text-gray-400 text-xs sm:text-sm">Total Minutes</p>
                            <p class="text-xl sm:text-2xl font-bold text-white">{{ analytics.listenTime?.totalMinutes }}</p>
                        </div>
                        <div>
                            <p class="text-gray-400 text-xs sm:text-sm">Formatted</p>
                            <p class="text-base sm:text-lg font-mono text-purple-400">{{ analytics.listenTime?.formatted }}</p>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="w-full min-w-[600px]">
                        ...
                        <tbody>
                            <tr v-for="(track, index) in analytics.mostPlayedTracks" :key="track.trackId"
                                ...
                                <td class="py-3 pr-2 sm:pr-4 text-white font-medium text-xs sm:text-sm">{{ track.title }}</td>
                                <td class="py-3 pr-2 sm:pr-4 text-gray-400 text-xs sm:text-sm">{{ track.artist || 'Unknown' }}</td>
                                <td class="py-3 pr-2 sm:pr-4 text-right text-white text-xs sm:text-sm">{{ track.playCount }}</td>
                                <td class="py-3 pr-2 sm:pr-4 text-right text-green-400 text-xs sm:text-sm">{{ track.completedPlays }}</td>
