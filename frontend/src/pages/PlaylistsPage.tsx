                  ...
                  {(styleColor || tempoLabel) && (
                    <div className="mt-1 flex flex-wrap gap-1">
                      ...
                      {styleColor && pl.subStyle && (
                        <span
                          className="inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium opacity-80"
                          style={{
                            backgroundColor: theme === 'dark' ? styleColor.bgDark : styleColor.bg,
                            color: theme === 'dark' ? styleColor.textDark : styleColor.text,
                          }}
                      ...
                      {tempoLabel && (
                        <span className="inline-flex items-center rounded-full bg-[rgb(var(--color-border))] px-2 py-0.5 text-xs font-medium text-[rgb(var(--color-text-muted))]">
                          {tempoLabel}
                        </span>
                      )}
                    </div>
