      ...
      <section className="space-y-3">
        ...
        <div className="rounded-lg border border-[rgb(var(--color-border))] bg-[rgb(var(--color-bg-elevated))] divide-y divide-[rgb(var(--color-border))]">
          <div className="flex items-center justify-between px-4 py-3">
            ...
            <span className="rounded-full bg-[rgb(var(--color-accent))]/10 px-2 py-0.5 text-sm font-medium text-[rgb(var(--color-accent))]">
              Ägare
            </span>
          </div>
              ...
              <div>
                ...
                <p className="text-xs text-[rgb(var(--color-text-muted))]">
                  ...
                  {collab.status === 'pending' && (
                    <span className="ml-1.5 rounded-full bg-[rgb(var(--color-border))] px-1.5 py-0.5 text-sm">
