              ...
              {mostPlayed.map((t, i) => (
                <div key={t.trackId} className="flex items-center gap-3">
                  ...
                  <div className="shrink-0 text-right">
                    ...
                    <p className="text-xs text-[rgb(var(--color-text-muted))]">{formatMinutes(t.totalDurationSeconds)} totalt</p>
                  </div>
                </div>
              ))}
            </div>
            <p className="mt-2 text-xs text-[rgb(var(--color-text-muted))]">Stapeln visar genomföringsgrad</p>
          </>
        )}
      </div>
